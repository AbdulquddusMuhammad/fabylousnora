    ...
    return (
        <div className="bg-gray-50 p-6 rounded-lg shadow-md sticky top-6">
            ...
            <button 
                ...
                className="w-full bg-[#6A0DAD] font-nunito hover:bg-[#5a0ca0] text-[12px] text-white font-bold py-3 transition mt-6 disabled:bg-gray-400  flex justify-center items-center"
            ...
            <button 
                className="w-full bg-[#ffffff] font-nunito text-[#6A0DAD] text-[12px] border border-[#6A0DAD] font-bold py-3 transition mt-4 disabled:bg-gray-400 "
                disabled={!cartItems.length || isProcessing}
            >
                Buy Now Pay Later
            </button>
        ...
        <div>
            ...
            <form>
                ...
                {formData.deliveryOption === 'pickup' && (
                    <p className="mt-4 text-gray-600 italic font-nunito text-sm">
